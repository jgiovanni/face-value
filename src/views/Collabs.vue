        ...
        <div class="ui-block responsive-flex">
          <div class="ui-block-title">
            <b-nav class="nav-tabs calendar-events-tabs">
              <b-nav-item :active="tabIndex === 0" @click="tabIndex = 0"
                >Collabs</b-nav-item
              >
              <b-nav-item :active="tabIndex === 1" @click="tabIndex = 1"
                >Collab Requests
                <span class="items-round-little bg-breez">{{
          ...
          <b-tab>
            <b-row>
              <b-col sm="6" md="6" lg="=4" xl="3">
                ...
                >
                  <b-link
                    @click="showModal('create-friend-group-1')"
                    class="full-block"
                  ></b-link>
                  <div class="content">
                    <b-link
                    ...
                    >
                      <svg class="olymp-plus-icon">
                        <use
                          xlink:href="/svg-icons/sprites/icons.svg#olymp-plus-icon"
                        ></use>
                      </svg>
                    </b-link>
              ...
              <b-col
                ...
                lg="=4"
                xl="3"
                v-for="collab in orderedCollabs"
                :key="collab.id"
              >
                <div class="ui-block">
                  <div class="friend-item friend-groups">
                    <div class="friend-item-content">
                      ...
                      <div class="friend-avatar">
                        ...
                        <div class="author-content">
                          <b-link
                            ...
                            class="h5 author-name"
                            ><!--:to="`/collabs/${collab.id}`"-->{{ collab.name }}</b-link
                          >
                          <div class="country">
                            {{
                              collab.users && Object.keys(collab.users).length
                            }}
                      ...
                      <ul class="friends-harmonic">
                        <li
                          v-for="(user, key) in collab.users"
                          :key="key"
                          v-b-tooltip.hover
                          :title="user.displayName"
                        >
                          <b-link :to="`/fv/${user.userName}`">
                      ...
                      <div class="control-block-button">
                        ...
                        <b-link
                          class="btn btn-control bg-success"
                          v-b-tooltip.hover
                          title="End Collab"
                        ...
                        <b-link
                          ...
                          v-b-tooltip.hover
                          title="Invite users"
                          @click="manageUsers(collab);"
                        >
                          <svg class="olymp-happy-faces-icon">
                            <use
                              xlink:href="/svg-icons/sprites/icons.svg#olymp-happy-faces-icon"
                            ></use>
                          </svg>
                        </b-link>

                        <b-link
                          class="btn btn-control btn-grey-lighter"
                          v-b-tooltip.hover
                          title="Collab Settings"
                          @click="editCollab(collab);"
                        >
                          <svg class="olymp-settings-icon">
                            <use
                              xlink:href="/svg-icons/sprites/icons.svg#olymp-settings-icon"
                            ></use>
                          </svg>
                        </b-link>
                      </div>
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="upcoming">
                      <div class="date-event inline-items align-left">
                        <svg class="olymp-small-calendar-icon">
                          <use
                            xlink:href="/svg-icons/sprites/icons.svg#olymp-small-calendar-icon"
                          ></use>
                        </svg>

                        <span class="month">
                          <timeago
                            :datetime="getTimestamp(request.created_at)"
                            :auto-update="300"
                          ></timeago>
                        </span>
                      </div>
                    ...
                    <td class="users">
                      <ul class="friends-harmonic">
                        <li
                          v-for="(user, key) in request.users"
                          :key="key"
                          v-b-tooltip.hover
                          :title="user.displayName"
                        >
                    ...
                    <td class="add-event">
                      <b-link
                        class="btn btn-sm btn-breez"
                        @click="acceptCollabRequest(request);"
                        >Accept / Confirm</b-link
                      >
                      <b-link
                        class="btn btn-sm btn-border-think custom-color c-grey"
                        @click="declineCollabRequest(request);"
                        >Decline / Delete</b-link
                      >
                    </td>
                  </tr>
                </tbody>
...
export default {
  ...
  methods: {
    manageUsers(collab) {
      ...
      this.showModal("create-friend-group-add-friends");
    },
    editCollab(collab) {
      this.selectedCollab = collab;
