					...
					<div class="header-content-wrapper">
						...
						<div class="form--login-logout">
							<form class="form-inline">
								...
								<button class="btn btn-primary btn-md-2" @click.prevent.stop="showAuthModal">Login/Register</button>
							</form>
							<a href="#" class="btn btn-primary btn-md-2 login-btn-responsive" @click.prevent="showAuthModal">Login/Register</a>
						</div>
					</div>
						...
						<div class="row">
							<div class="col col-xl-4 col-lg-12 col-md-12 m-auto">
								<div class="logout-content">
									...
									<p><a href="#" @click.prevent="showAuthModal">Login</a> or <a href="#" @click.prevent="showAuthModal">Register</a> now to create your own profile
										and have access to OCAD U's skill share community!
									</p>
								</div>
							</div>
						</div>
