<template>
  <div>
    <div
      class="main-header main-header-fullwidth main-header-has-header-standard"
    >
      <PublicHeader />
        ...
        <div class="row display-flex">
          <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="landing-content">
              ...
              <p>
                Our app brings together students from different programs, with
                different skill sets, to collaborate and learn from each other
                in a “less pressure” environment.
              </p>
              <!--
                ...
                <li class="nav-item">
                  ...
                  >
                    <svg class="olymp-login-icon">
                      <use
                        xlink:href="/svg-icons/sprites/icons.svg#olymp-login-icon"
                      ></use>
                    </svg>
                  </a>
                </li>
                <li class="nav-item">
                  ...
                  >
                    <svg class="olymp-register-icon">
                      <use
                        xlink:href="/svg-icons/sprites/icons.svg#olymp-register-icon"
                      ></use>
                    </svg>
                  </a>
                </li>
              ...
              <div class="tab-content">
                <div class="tab-pane active" v-show="authView === 'login'">
                  ...
                  <b-form
                    novalidate
                    class="content"
                    :validated="forms.login.validated"
                    ...
                    <div class="row">
                      ...
                      >
                        <b-form-group
                          ...
                          :class="{ 'is-empty': !credentials.email }"
                        ...
                        <b-form-group
                          class="form-group label-floating"
                          :class="{ 'is-empty': !credentials.password }"
                        ...
                        <p
                          class="invalid-feedback d-block text-center pb-4"
                          v-if="forms.login.code"
                          v-html="
                            forms.login.code === 'auth/user-not-found'
                              ? 'There is no record of this account. <br/> Please create an account.'
                              : forms.login.message
                          "
                        ></p>
                        ...
                        <p>
                          ...
                          <a href="#" @click="authView = 'register';"
                            >Register Now!</a
                          >
                ...
                <div class="tab-pane active" v-show="authView === 'register'">
                  ...
                  <b-form
                    novalidate
                    class="content"
                    :validated="forms.register.validated"
                  ...
                  >
                    <div class="row">
                      ...
                      >
                        <b-form-group
                          class="form-group label-floating"
                          :class="{ 'is-empty': !newUser.firstName }"
                      ...
                      >
                        <b-form-group
                          class="form-group label-floating"
                          :class="{ 'is-empty': !newUser.lastName }"
                      ...
                      >
                        ...
                        <b-form-group
                          class="form-group label-floating"
                          :class="{ 'is-empty': !newUser.userName }"
                          :state="errorState('userName', 'register')"
                          :invalid-feedback="
                            errors.first('userName', 'register')
                          "
                          label="User Name"
                          label-class="control-label"
                        ...
                        <b-form-group
                          class="form-group label-floating"
                          :class="{ 'is-empty': !newUser.password }"
                        ...
                        <div class="remember">
                          <b-form-group
                            class="checkbox"
                            :invalid-feedback="
                              errors.first('terms', 'register')
                            "
                          >
                            <md-checkbox
                              class=""
                              v-model="newUser.acceptedTOS"
                              data-vv-name="terms"
                              data-vv-as="Terms of Service"
                              type="checkbox"
                              v-validate="'required'"
                              id="terms"
                              name="terms"
                            ...
                            <div
                              v-show="
                                !newUser.acceptedTOS && forms.register.validated
                              "
                              role="alert"
                              aria-live="assertive"
                              aria-atomic="true"
          ...
          <div class="col col-xl-4 col-lg-4 m-auto col-md-12 col-sm-12 col-12">
            <div class="crumina-module crumina-heading">
              <h2 class="heading-title">
                Why Join
                <span class="c-primary">FaceValue Skill Sharing Network</span>?
              </h2>
        ...
        <div class="row">
          <div class="col col-xl-4 col-lg-4 m-auto col-md-12 col-sm-12 col-12">
            <div class="crumina-module crumina-heading">
              <h2 class="heading-title">
                Meet New People
                <span class="c-primary">all over the World</span>
              </h2>
              <p class="heading-text">
                Vector files need fine tuning? Struggling with Adobe Premier?
                Tangled in your Arduino Project? Or Maybe this is your second
                time printing and you need an expert peer, to tell you if your
                files are print ready.I mean sure you could ask a classmate...
                and yes you can ask a friend but, that doesn't always work out
                so great, theres no accountability and quite frankly you feel
                like a pain in the neck. Our website, Face Value, brings
                together students from different programs, with different skill
                sets, to collaborate and learn from each other in a “less
                pressure” environment. Users create a profile that lists the
                skills they are willing to share with each other without asking
                for anything in return. Contribution is encouraged, but everyone
                is welcome even if they don't have a skill to share. As users
                connect with each other, these purposed engagements help users
                increase their network which can potentially lead to collabs,
                paid gigs, and even employment.
              </p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col col-xl-4 col-lg-4 m-auto col-md-12 col-sm-12 col-12">
            <div class="crumina-module crumina-heading">
              <h2 class="heading-title">
                The Best UI/UX and
                <span class="c-primary">Awesome Features</span>
              </h2>
              <p class="heading-text">
                By starting with the OCAD student body we feel we can develop a
                model which can then grow to include a wider demographic of
                artists, individuals, and small businesses. More and more our
                economy seeks diverse skill sets in individuals, but the
                resources aren’t always there (Google only helps when you know
                what to look for). Our web platform answers this need by
                connecting individuals with people who have specific skill sets,
                providing help in areas of interest, or weakness.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col col-xl-4 col-lg-4 m-auto col-md-12 col-sm-12 col-12">
            <div class="crumina-module crumina-heading">
              <h2 class="heading-title">
                Find People with
                <span class="c-primary">Your Same Interests</span>
              </h2>
              <p class="heading-text">
                The mission of Face Value is to foster a community of
                collaborative thinking and sharing, by connecting students from
    ...
    <section
      class="medium-padding120 bg-section3 background-cover planer-animation"
    >
      <div class="container">
        <div class="row mb60">
          <div class="col col-xl-4 col-lg-4 m-auto col-md-12 col-sm-12 col-12">
                ...
                <div class="crumina-module crumina-testimonial-item">
                  ...
                  <div class="testimonial-item-content">
                    ...
                    <ul class="rait-stars">
                      ...
                      <li><i class="fa fa-star star-icon"></i></li>
                      <li><i class="fa fa-star star-icon"></i></li>
                      <li><i class="far fa-star star-icon"></i></li>
                    </ul>

                    <p class="testimonial-message">
                      Never thought going out of my way to help somebody else
                      would be so rewarding! What goes around comes around
                      folks! Amazing interface, cant wait to actually start some
                      projects....
                    </p>
                ...
                <div class="crumina-module crumina-testimonial-item">
                  ...
                  <div class="testimonial-item-content">
                    ...
                    <h3 class="testimonial-title">
                      This is the Best Skill Sharing Network ever!
                    </h3>
                    ...
                    <p class="testimonial-message">
                      Got amazing feedback on my thesis, actually got my
                      prototye to work with some phyical computing help from Ted
                      Halloway on Face Value. So excited to present it!
                    </p>
          ...
          <div class="col col-xl-5 col-lg-5 m-auto col-md-12 col-sm-12 col-12">
            <div class="crumina-module crumina-heading">
              <h2 class="h1 heading-title">
                ...
                <span class="c-primary">FaceValue App!</span>
              </h2>
              <p class="heading-text">
                Face Value provides a new way to collaborate on projects, ask
                our fellow peers/artists for help and network within our own
                community.
              </p>
            </div>
            ...
            <ul class="list--styled">
              <li>
                <i class="far fa-check-circle" aria-hidden="true"></i> Build
                your profile in just minutes, it’s that simple!
              </li>
              <li>
                <i class="far fa-check-circle" aria-hidden="true"></i> Unlimited
                messaging with the best interface.
              </li>
            </ul>
            ...
            <a href="#" class="btn btn-market">
              <img
                class="icon"
                src="/svg-icons/apple-logotype.svg"
                alt="app index"
              />
              <div class="text">
    ...
    <section
      class="align-right pt160 pb80 section-move-bg call-to-action-animation scrollme"
    >
      <div class="container">
        <div class="row">
          <div
    ...
    <div
      class="modal fade"
      id="registration-login-form-popup"
      tabindex="-1"
      role="dialog"
      aria-labelledby="registration-login-form-popup"
      aria-hidden="true"
    >
      <div
        class="modal-dialog window-popup registration-login-form-popup"
        role="document"
      >
                  ...
                  <form class="content">
                    <div class="row">
                      ...
                      >
                        ...
                        <div class="form-group date-time-picker label-floating">
                          ...
                          <span class="input-group-addon">
                            <svg class="olymp-calendar-icon">
                              <use
                                xlink:href="/svg-icons/sprites/icons.svg#olymp-calendar-icon"
                              ></use>
                            </svg>
                          </span>
                        </div>
                        ...
                        <a href="#" class="btn btn-purple btn-lg full-width"
                  ...
                  <form class="content">
                    <div class="row">
                      ...
                      >
                        ...
                        <a href="#" class="btn btn-lg btn-primary full-width"
                          >Login</a
                        >
                        ...
                        <a
                          href="#"
                          class="btn btn-lg bg-facebook full-width btn-icon-left"
                        ...
                        <a
                          href="#"
                          class="btn btn-lg bg-twitter full-width btn-icon-left"
        ...
        <div class="row">
          ...
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="sub-footer-copyright">
              <span>
                Copyright <router-link to="/">FaceValue</router-link> All Rights
                Reserved 2017
              </span>
            </div>
