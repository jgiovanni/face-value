<template>
  <div class="ui-block">
    <article class="hentry post">
      <div class="post__author author vcard inline-items">
        ...
        <div class="author-date">
          <router-link
            ...
            v-text="item.author.displayName"
          ></router-link>
          ...
          <div class="post__date">
            <time
              v-if="this.item.created_at && timestamp"
              class="published"
      ...
      <div class="mb-3">
        <md-chip
          v-for="chip in item.skillsList"
          :key="chip"
          md-clickable
          @click="searchSkill(chip);"
          >{{ chip }}</md-chip
        >
      </div>
      ...
      <div class="post-additional-info inline-items">
        ...
        <div class="names-people-likes">
          <Aggregator
            :item="item"
            count-prop="like_count"
            :user-included="liked"
            recents-prop="recent_likes"
            verb="liked"
          />
        </div>
        ...
        <div class="comments-shared">
          <a
            href="#"
            @click.prevent="startConversation"
            class="post-add-icon inline-items"
            :class="{ active: hasChatted }"
            v-if="!userIsAuthor"
          >
            <svg class="olymp-speech-balloon-icon">
              <use
                xlink:href="/svg-icons/sprites/icons.svg#olymp-speech-balloon-icon"
              ></use>
            </svg>
      ...
      <div class="control-block-button post-control-button">
        ...
        >
          <svg class="olymp-like-post-icon">
            <use
              xlink:href="/svg-icons/sprites/icons.svg#olymp-like-post-icon"
            ></use>
          </svg>
        </a>
    ...
    >
      ...
      <button type="submit" class="btn btn-md-2 btn-primary">
        Send Message
      </button>
    ...
    sendMessage() {
      ...
      this.$store
        ...
        .then(newChatId => {
          ...
          this.$store
            .dispatch("chats/messages/openDBChannel", { chatId: newChatId })
            .then(() => {
              this.$store
