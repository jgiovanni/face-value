	...
	<div>
		...
		<div class="fixed-sidebar" :class="{ 'open': sidebarState }">
			...
			<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
				...
				<div class="mCustomScrollbar" data-mcs-theme="dark">
					<ul class="left-menu">
						<li>
							<a href="#" @click.prevent="toggleSidebar" class="js-sidebar-open">
		...
		<div class="fixed-sidebar fixed-sidebar-responsive">
			...
			<div class="fixed-sidebar-left sidebar--small" id="sidebar-left-responsive">
				<a href="#" @click.prevent="toggleSidebar" class="logo js-sidebar-open">
					<img src="img/logo.png" alt="Olympus">
				</a>
			...
			<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
				...
				<div class="mCustomScrollbar" data-mcs-theme="dark">
					...
					<ul class="left-menu">
						...
						<li>
							<router-link to="/">
								<svg class="olymp-newsfeed-icon left-menu-icon" v-b-tooltip.hover.right title="NEWSFEED">
						...
						<li>
							<a href="Mobile-28-YourAccount-PersonalInformation.html">
								<svg class="olymp-star-icon left-menu-icon" v-b-tooltip.hover.right title="FAV PAGE">
						...
						<li>
							<a href="mobile-29-YourAccount-AccountSettings.html">
								<svg class="olymp-happy-faces-icon left-menu-icon" v-b-tooltip.hover.right title="FRIEND GROUPS">
						...
						<li>
							<a href="Mobile-30-YourAccount-ChangePassword.html">
								<svg class="olymp-headphones-icon left-menu-icon" v-b-tooltip.hover.right title="MUSIC & PLAYLISTS">
						...
						<li>
							<a href="Mobile-31-YourAccount-HobbiesAndInterests.html">
								<svg class="olymp-weather-icon left-menu-icon" v-b-tooltip.hover.right title="WEATHER APP">
						...
						<li>
							<a href="Mobile-32-YourAccount-EducationAndEmployement.html">
								<svg class="olymp-calendar-icon left-menu-icon" v-b-tooltip.hover.right title="CALENDAR AND EVENTS">
						...
						<li>
							<a href="Mobile-33-YourAccount-Notifications.html">
								<svg class="olymp-badge-icon left-menu-icon" v-b-tooltip.hover.right title="Community Badges">
						...
						<li>
							<a href="Mobile-34-YourAccount-ChatMessages.html">
								<svg class="olymp-cupcake-icon left-menu-icon" v-b-tooltip.hover.right title="Friends Birthdays">
						...
						<li>
							<a href="Mobile-35-YourAccount-FriendsRequests.html">
								<svg class="olymp-stats-icon left-menu-icon" v-b-tooltip.hover.right title="Account Stats">
						...
						<li>
							<a href="#">
								<svg class="olymp-manage-widgets-icon left-menu-icon" v-b-tooltip.hover.right title="Manage Widgets">
